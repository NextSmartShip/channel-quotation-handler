...
import baierDhlZones from '../config/baier_dhl_zones.json';
import { COST_MODE } from '../config/const';
import countries from '../config/countries.json';
import { isIncludeHeader } from './utils';

export function checkBaierDhlTemplateIsValid(json) {
...
export function handleBaierDhlExcelJson(json) {
  const items = [];
  ...
  const countryZones = baierDhlZones.data;
